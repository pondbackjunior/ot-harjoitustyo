...
class EditorMain:
    def __init__(self, root, textarea):
        ...
        # Keyboard shortcuts
        self._textarea.bind("<Control-b>", lambda _: (self.insert_tag("b"), "break")[1]) # Bold
        self._textarea.bind("<Control-i>", lambda _: (self.insert_tag("i"), "break")[1]) # Italic
        self._textarea.bind("<Control-u>", lambda _: (self.insert_tag("u"), "break")[1]) # Underline
        self._textarea.bind("<Control-a>", lambda _: (self._textarea.tag_add("sel", "1.0", "end-1c"), "break")[1]) # Select all
